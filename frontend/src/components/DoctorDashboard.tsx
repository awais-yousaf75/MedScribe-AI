...
export function DoctorDashboard({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Assistants card (improved layout) */}
      <div className="rounded-2xl border border-slate-200 bg-white p-4 md:p-5 space-y-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-slate-500">
              Add assistants to help manage patients. New assistants must be
              approved by the hospital admin before they can log in.
            </p>
          </div>
          <Button
            size="sm"
        ...
        <div className="mt-3 grid gap-6 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,1.1fr)]">
          {/* Left: Add assistant form */}
          <div className="rounded-xl border border-slate-200 bg-slate-50/60 p-4 space-y-3">
            <h3 className="text-xs font-semibold text-slate-800">
              Add New Assistant
            </h3>
            <p className="text-[11px] text-slate-500">
              Provide initial credentials. The assistant will receive an email
              and be able to log in once approved by the hospital admin.
            </p>
            <form
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-4 space-y-3">
            ...
            {loadingAssistants ? (
              ...
              <p className="text-xs text-slate-400">
                No assistants added yet. Use the form on the left to add one.
              </p>
            ) : (
                ...
                <table className="w-full table-fixed text-xs">
                  <thead className="bg-slate-50/80">
                    <tr className="border-b border-slate-200 text-left text-[11px] font-semibold text-slate-500">
                      <th className="py-2.5 px-3 w-[34%]">Name</th>
                      <th className="py-2.5 px-3 w-[26%]">Phone</th>
                      <th className="py-2.5 px-3 w-[16%]">Status</th>
                      <th className="py-2.5 px-3 w-[24%]">Info</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-100 bg-white">
                    {assistants.map((a) => (
                      <tr key={a.profile_id} className="hover:bg-slate-50/60">
                        ...
                        <td className="py-2.5 px-3 align-top text-[11px] text-slate-500">
