// src/pages/assistant/ChangePasswordPage.tsx
// Same exact code as DoctorChangePasswordPage but using API endpoint /api/profile/change-password
// (which is already shared for all roles)

import { useState } from "react";
import {
  Key, Lock, Eye, EyeOff, RefreshCw, CheckCircle, X,
} from "lucide-react";
